  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        /* Brand — identity only (teal). Never use for risk states. */
        brand: {
          DEFAULT: "hsl(var(--brand))",
          muted: "hsl(var(--brand-muted))",
          tint: "hsl(var(--brand-tint))",
        },
        /* Semantic — meaning only. Never use for branding. */
        risk: {
          DEFAULT: "hsl(var(--risk))",
          tint: "hsl(var(--risk-tint))",
        },
        danger: {
